...
mod LizInventory {
    ...
    fn add_stock(product: felt252, new_stock: u32) {      
        ...
        let new_total_stock: u32 = inventory::read(product) + new_stock;
        inventory::write(product , new_total_stock);
    ...
    fn purchase(product: felt252, quantity: u32) {
        ...
        assert(inventory::read(product) >= quantity , 'not enough');
        let new_total_stock: u32 = inventory::read(product) - quantity;
        inventory::write(product,new_total_stock);
    }
